...
export default function LinkIcon(props) {
  return (
    <svg width="193" height="193" viewBox="0 0 193 193" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M96.5 193C149.795 193 193 149.795 193 96.5C193 43.2045 149.795 0 96.5 0C43.2045 0 0 43.2045 0 96.5C0 149.795 43.2045 193 96.5 193Z" fill="url(#link_iconpaint0_linear)" />
      ...
      <defs>
        <linearGradient id="link_iconpaint0_linear" x1="96.5" y1="0" x2="96.5" y2="193" gradientUnits="userSpaceOnUse">

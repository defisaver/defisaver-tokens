...
export default function CrvHusdIcon(props) {
  const id = `crv_husd_icon_${uuid()}`;
  const id1 = `1_${id}`;
  const id2 = `2_${id}`;
  const fill1 = `url(#${id1})`;
  const fill2 = `url(#${id2})`;
  return (
    <svg width="193" height="194" viewBox="0 0 193 194" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <circle cx="96.5" cy="97.5" r="96.5" fill={fill1} />
      <path fillRule="evenodd" clipRule="evenodd" d="M132 145H114.216V114.638C114.216 109.775 110.248 105.823 105.345 105.823H105.337H79.7757C69.9606 105.823 62 97.9279 62 88.1936V49.0083H79.7757V79.379C79.7757 84.242 83.7518 88.1936 88.6551 88.1936H114.216C124.031 88.2019 131.983 96.0887 131.992 105.823L132 145ZM80.3938 145H62.6098V115.391C72.4248 115.391 80.3854 123.278 80.3854 133.021L80.3938 145ZM113.606 49H131.382V78.6251C121.558 78.6251 113.606 70.7301 113.606 60.9959V49Z" fill="white"/>
      ...
      <defs>
        <linearGradient id={id1} x1="96.5" y1="193.988" x2="96.5" y2="0.988186" gradientUnits="userSpaceOnUse">

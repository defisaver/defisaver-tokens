...
export default function CrvStethIcon(props) {
  const id = `crv_steth_icon_${uuid()}`;
  const id1 = `1_${id}`;
  const id2 = `2_${id}`;
  const fill1 = `url(#${id1})`;
  const fill2 = `url(#${id2})`;
  return (
    <svg width="193" height="193" viewBox="0 0 193 193" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M97.0391 39L123.273 80.0627L97.0391 95.3473L70.8052 80.0627L97.0391 39ZM78.8343 78.1177L97.0391 49.6261L115.239 78.1177L97.0338 88.7279L78.8343 78.1124V78.1177Z" fill="white"/>
      <path d="M97.0019 104.373L66.5652 86.645L65.7332 87.9435C61.1846 95.0648 59.2042 103.526 60.1198 111.926C61.0354 120.326 64.792 128.162 70.768 134.136C77.7252 141.093 87.1607 145.001 96.9992 145.001C106.838 145.001 116.273 141.093 123.231 134.136C129.206 128.162 132.963 120.326 133.879 111.926C134.794 103.526 132.814 95.0648 128.265 87.9435L127.428 86.645L97.0019 104.373Z" fill="white"/>

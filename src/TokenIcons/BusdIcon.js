...
export default function BusdIcon(props) {
  return (
    <svg width="193" height="193" viewBox="0 0 193 193" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <circle cx="96.5" cy="96.5" r="96.5" fill="url(#busd_iconpaint0_linear)" />
      ...
      <defs>
        <linearGradient id="busd_iconpaint0_linear" x1="96.5" y1="0" x2="96.5" y2="193" gradientUnits="userSpaceOnUse">

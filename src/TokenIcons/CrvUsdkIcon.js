...
export default function CrvUsdkIcon(props) {
  const id = `crv_usdk_icon_${uuid()}`;
  const id1 = `1_${id}`;
  const id2 = `2_${id}`;
  const fill1 = `url(#${id1})`;
  const fill2 = `url(#${id2})`;
  return (
    <svg width="193" height="193" viewBox="0 0 193 193" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M67.7742 55V99.4496H42C96.4 123.485 132.667 79.8314 144 55H110C109.634 59.0242 110.576 67.0727 117.266 67.0727C116.937 72.4506 102.78 82.7581 95.7419 87.2397V55H67.7742Z" fill="white"/>
      <path d="M67.7742 138V112.345C92.7806 112.345 112.102 102.742 118.637 97.9405L141.669 138H116.306L102.597 109.876L95.7419 112.345V138H67.7742Z" fill="white"/>
      ...
      <defs>
        <linearGradient id={id1} x1="96.5" y1="192.988" x2="96.5" y2="-0.0118143" gradientUnits="userSpaceOnUse">
